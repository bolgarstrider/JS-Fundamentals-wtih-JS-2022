...
// 4.	For each word, specify that it should begin with an uppercase letter using a character set. The desired characters 
// are in a range – from 'A' to 'Z'.
// 5.	For each word, specify that what follows the first letter are only lowercase letters, one or more – use another 
// character set and the correct quantifier.
// 6.	To prevent capturing of letters across new lines, put "\b" at the beginning and the end of your regex. This will 
// ensure that what precedes and what follows the match is a word boundary (like a new line).
