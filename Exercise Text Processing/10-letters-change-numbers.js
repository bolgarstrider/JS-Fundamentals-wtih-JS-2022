...
//  The game is simple. You get a string consisting of a number between two letters. Depending on whether the letter was in 
//  front of the number or after it you would perform different mathematical operations on the number to achieve the result.
...
//  the number on the first string. A is Uppercase and its position in the alphabet is 1. So we divide the number 12 
//  with position 1 (12/1 = 12). Then we move to the letter after the number. b is lowercase and its position is 2. 
//  So we add 2 to the resulting number (12+2=14). Similarly for the second string s is lowercase and its position 
//  is 19 so we multiply it with the number (17*19 = 323). Then we have Uppercase G with position 7, so we subtract 
